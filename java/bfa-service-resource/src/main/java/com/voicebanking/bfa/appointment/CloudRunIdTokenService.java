...
/**
 * Resolves Google-signed identity tokens for private Cloud Run backends.
 *
 * <p>Uses a dedicated serverless authorization header so application-level
 * {@code Authorization} semantics remain untouched for mock-server flows.</p>
 */
@Component
public class CloudRunIdTokenService {

    private static final Logger log = LoggerFactory.getLogger(CloudRunIdTokenService.class);
    static final String SERVERLESS_AUTHORIZATION_HEADER = "X-Serverless-Authorization";
